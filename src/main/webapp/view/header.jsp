...
<nav>
	...
	<ul class="nav-links">
		<c:if test="${currentUser != null}">
			...
			<li><a href="/listOrder">Orders</a></li>
			<li><a href="/listOrderByTableNumber">Orders By Table</a></li>
			<li><a href="/changeTableNumber">Change Table</a></li>
	...
	<a href="/">Table <input type="number" id="currentTableNumber"
		readonly /></a>	
</nav>
